...
//var_dump($result->get('test4'));
	...
	var_dump($redis->lRange("test", 3, 1));  //结果：string(3) "444"
	...
	$redis->lpush("test", "111");
	$redis->lpush("test", "222");
	var_dump($redis->lRange("test", 0, 0));  //结果：string(3) "111"
	var_dump($redis->lset("test", 1, "333"));  //结果：bool(true)
	var_dump($redis->lRange("test", 0, 1));  //结果：string(3) "333"