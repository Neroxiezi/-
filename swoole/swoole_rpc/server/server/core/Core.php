<?php
    ...
    class Core
    {
        ...
        protected static function workerStart()
        {
            ...
            self::$serv->on(
                'WorkerStart',
                function ($serv, $worker_id) use ($config) {
            ...
            $tcp->on(
                'Receive',
                function ($serv, $fd, $reactor_id, $data) {
            ...
            $udp->on(
                'Packet',
                function ($serv, $data, $client_info) {
                    $packet = new OnPacket();
            ...
            self::$serv->on(
                'Task',
                function ($serv, $task_id, $src_worker_id, $data) use ($config) {
                    $task = new OnTask();
