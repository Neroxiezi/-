...
class EventTest extends TestCase {
    ...
    public function setUp() {
        ...
        $eventAttendLimit = 10;
        $this->event      = new \Src\Event($eventId, $eventName, $eventStartDate, $eventEndDate, $eventAttendLimit);

        $userId     = 1;
        $userName   = 'User1';
        $userEmail  = 'user1@zoco.space';
        $this->user = new \Src\User($userId, $userName, $userEmail);
    }
    ...
    public function testAttendeeLimitReserve($eventId, $eventName, $eventStartDate, $eventEndDate, $eventAttendLimit) {
        // 测试报名人数限制
        $event      = new \Src\Event($eventId, $eventName, $eventStartDate, $eventEndDate, $eventAttendLimit);
        $userNumber = 6;
        ...
        for ($userCount = 1; $userCount < $userNumber; $userCount++) {
            ...
            $user      = new \Src\User($userId, $userName, $userEmail);
    ...
    /**
     * @expectedException \Src\EventException
