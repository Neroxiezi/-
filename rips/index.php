...
<head>
	...
	<title>RIPS——PHP脚本中漏洞的静态源代码分析程序</title>
</head>
<body>
...
<div class="menu">
	...
	<tr><td width="75%" nowrap>
		...
		<tr>
			...
			<td nowrap><input type="checkbox" id="subdirs" value="1" title="check to scan subdirectories" checked/>扫描所有子目录
			</td>
		</tr>
		<tr>
			<td nowrap>扫描结果的详细程度:</td>
			<td nowrap>
...
<div id="result">
	...
	<div style="margin-left:30px;color:#000000;font-size:14px">
		<h3>快速入门::</h3>
		<p>定位您的本地PHP源代码<b>path / file</b> (e.g. <em>/var/www/project1/</em> or <em>/var/www/index.php</em>), 选择<b>漏洞类型</b> 并点击 <u>scan</u>!<br />
		勾选 <b>扫描所有子目录</b>将所有子目录包含到扫描中。建议只扫描项目的根目录。子目录中的文件将被包含在PHP代码中的RIPS自动扫描。<b>subdirs</b> 可以改进扫描结果和包括成功率(如结果所示)。</p>
		<h3>高级的:</h3>
		<p>调试错误或通过选择不同的结果来提高您的扫描结果:<b>扫描结果的详细程度</b> (default level 1 is recommended).<br />
